...
<xsl:template name="hhk">
  <xsl:call-template name="write.text.chunk">
    ...
    <xsl:with-param name="method" select="'text'"/>
    <xsl:with-param name="content">&lt;!DOCTYPE HTML PUBLIC "-//IETF//DTD HTML//EN"&gt;
&lt;HTML&gt;
&lt;HEAD&gt;
...
<xsl:template name="write.indexterm.hhk">
  ...
  &lt;LI&gt; &lt;OBJECT type="text/sitemap"&gt;
        &lt;param name="Name" value="<xsl:value-of select="$text.escaped"/><xsl:text>"&gt;</xsl:text>
      <xsl:if test="not(seealso)">
        ...
        &lt;param name="Name" value="<xsl:value-of select="$title"/>"&gt;
        &lt;param name="Local" value="<xsl:value-of select="$href"/>"&gt;
      </xsl:if>
      <xsl:if test="seealso">
        &lt;param name="See Also" value="<xsl:value-of select="$seealso"/>"&gt;
      </xsl:if>
