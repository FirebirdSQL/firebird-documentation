...
Copies of the License are available at http://www.firebirdsql.org/pdfmanual/pdl.pdf[http://www.firebirdsql.org/pdfmanual/pdl.pdf] (PDF) and http://www.firebirdsql.org/manual/pdl.html[http://www.firebirdsql.org/manual/pdl.html] (HTML).
