...
Therefore, for many very small records, reserve can be close to 50% of data page, and for the single huge record can be 17 bytes or so (depends on the version of On-Disk Structure of the database).
