...
Refer to the https://www.firebirdsql.org/file/documentation/html/en/firebirddocs/docbuildhowto/firebird-docbuilding-howto.html#docbuildhowto-checking-out[Docbuilding Howto] if you don't remember how to perform an git checkout.
...
----
+
The words "```this link```" will rendered as a hyperlink to ``https://tdg.docbook.org/``, like this:
+
[quote]
