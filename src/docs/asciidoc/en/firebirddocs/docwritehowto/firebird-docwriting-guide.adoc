...
If this applies to you, please talk about it on the firebird-devel list.
...
* https://www.tldp.org/HOWTO/DocBook-Demystification-HOWTO/
+
...
A good one, and free at that, is [app]``ConText``, available at http://www.contexteditor.org/index.php.
...
Requires Java, but you need Java anyway or you won't be able to build the docs from the sources – see the https://www.firebirdsql.org/file/documentation/html/en/firebirddocs/docbuildhowto/firebird-docbuilding-howto.html[Firebird Docbuilding Howto].
+
...
* [app]``Altova XMLSpy``
+
https://www.altova.com/xmlspy-xml-editor[https://www.altova.com/products_ide.html]
+
...
(But if you fill them in an attribute editor, don't insert quotes: the editor will take care of them.)
...
[source]
----
Click <ulink url="https://tdg.docbook.org/">this link</ulink> to
read The Definitive Guide on DocBook.
----
+
The words "```this link```" will render as a hyperlink to ``https://tdg.docbook.org/``, like this:
+
[quote]
Click https://tdg.docbook.org/[this link] to read The Definitive Guide on DocBook.
...
----
Send mail to 
<email>firebird-devel+subscribe@googlegroups.com</email> to
subscribe.
----
+
...
+
[quote]
Send mail to mailto:firebird-devel+subscribe@googlegroups.com[firebird-devel+subscribe@googlegroups.com] to subscribe.
+
