...
* Copyright and the Public Documentation License. (TODO: Currently part of DocBook specific chapter)
...
CAUTION: This section is outdated, and does not reflect the location for files generated from AsciiDoc sources.
...
CAUTION: This section is outdated.
The documentation index is maintained in the CMS of the Firebird website.
