...
The response is sent as part of a stream of responses to <<wireprotocol-statements-execute>> (specifically `op_execute2`), `op_executeimmediate2` (not yet documented), <<wireprotocol-statements-fetch>>, and <<wireprotocol-statements-fetch-scroll>>.
