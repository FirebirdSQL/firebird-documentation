...
To learn more about UDFs, consult the [ref]_InterBase 6.0 Developer's Guide_ (free at http://www.ibphoenix.com/downloads/60DevGuide.zip), [ref]_Using Firebird_ and the [ref]_Firebird Reference Guide_ (both on CD), or the [ref]_Firebird Book_.
CD and book can be purchased via http://www.ibphoenix.com.
