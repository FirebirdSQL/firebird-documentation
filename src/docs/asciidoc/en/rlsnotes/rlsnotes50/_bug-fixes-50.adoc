...
[[bug-504]]
== Firebird 5.0.4 Release: Bug Fixes

[[bug-504-core]]
=== Core Engine

_https://github.com/FirebirdSQL/firebird/issues/8965[#8965]_
-- Wrong `PERCENT_RANK` computation  

_Implemented by Denis Simonov_

'''

_https://github.com/FirebirdSQL/firebird/pull/8937[#8937]_
-- Get rid of the unnecessary permissions for implicit domains  

_Implemented by Dmitry Yemanov_

'''

_https://github.com/FirebirdSQL/firebird/issues/8926[#8926]_
...
_https://github.com/FirebirdSQL/firebird/issues/8914[#8914]_
-- `SELECT` with multiple `EXISTS` sub-queries fails in case of `SubQueryConversion = true`  

_Implemented by Dmitry Yemanov_

'''

_https://github.com/FirebirdSQL/firebird/issues/8911[#8911]_
-- Wrong result in case of `SubQueryConversion = true`  

_Implemented by Dmitry Yemanov_

'''

_https://github.com/FirebirdSQL/firebird/issues/8903[#8903]_
-- Use of some switches with parameter in _gbak_'s command line before name of database in '-SE' mode breaks access to databases with non-default security database  

_Implemented by Alexander Peshkov_

'''

_https://github.com/FirebirdSQL/firebird/issues/8901[#8901]_
-- Bugcheck during _nbackup_ under high load  

_Implemented by Vlad Khorsun_

'''

_https://github.com/FirebirdSQL/firebird/issues/8892[#8892]_
-- `JOIN` on nested `UNION` leads in `CROSS JOIN` and Full Table Scan

_Implemented by Dmitry Yemanov_

'''

_https://github.com/FirebirdSQL/firebird/issues/8891[#8891]_
-- Result of cross join of two procedures + unioned with common datasource (e.g. `RDB$DATABASE`) is wrong

_Implemented by Dmitry Yemanov_

'''

_https://github.com/FirebirdSQL/firebird/issues/8885[#8885]_
-- AV when lock manager settings is misconfigured  

_Implemented by Vlad Khorsun_

'''

_https://github.com/FirebirdSQL/firebird/issues/8881[#8881]_
...
_https://github.com/FirebirdSQL/firebird/pull/8872[#8872]_
...
_https://github.com/FirebirdSQL/firebird/pull/8871[#8871]_
...
_https://github.com/FirebirdSQL/firebird/issues/8857[#8857]_
-- Replication stops if `GRANT` was issued by non-DBA user who has the `RDB$ADMIN` role and appropriate object (table, etc) belongs to another user  

_Implemented by Dmitry Yemanov_

'''

_https://github.com/FirebirdSQL/firebird/issues/8851[#8851]_
...
_https://github.com/FirebirdSQL/firebird/pull/8826[#8826]_
...
_https://github.com/FirebirdSQL/firebird/issues/8821[#8821]_
-- REGRESSION: natural plan instead of primary/unique index  

_Implemented by Dmitry Yemanov_

'''

_https://github.com/FirebirdSQL/firebird/issues/8817[#8817]_
...
_https://github.com/FirebirdSQL/firebird/issues/8799[#8799]_
...
_https://github.com/FirebirdSQL/firebird/issues/8794[#8794]_
-- Called procedure parameter changes during execution without assignment when deleting from updatable view  

_Implemented by Vlad Khorsun_

'''

_https://github.com/FirebirdSQL/firebird/pull/8772[#8772]_
-- Incorrect calculation of last used page  

_Implemented by Artyom Ivanov_

'''

_https://github.com/FirebirdSQL/firebird/pull/8766[#8766]_
...
_https://github.com/FirebirdSQL/firebird/issues/8755[#8755]_
...
_https://github.com/FirebirdSQL/firebird/issues/8749[#8749]_
-- Computed index on `RDB$RECORD_VERSION` doesn't work as expected  

_Implemented by Vlad Khorsun_

'''

_https://github.com/FirebirdSQL/firebird/issues/8739[#8739]_
...
_https://github.com/FirebirdSQL/firebird/issues/8737[#8737]_
-- "Statement 0, <unknown, bug?>" in trace  

_Implemented by Artyom Abakumov_

'''

_https://github.com/FirebirdSQL/firebird/pull/8732[#8732]_
-- Add support of the `IN <list>` predicate to the equality distribution logic  

_Implemented by Dmitry Yemanov_

'''

_https://github.com/FirebirdSQL/firebird/issues/8726[#8726]_
...
_https://github.com/FirebirdSQL/firebird/issues/8705[#8705]_
...
_https://github.com/FirebirdSQL/firebird/pull/8688[#8688]_
...
_https://github.com/FirebirdSQL/firebird/pull/8687[#8687]_
...
_https://github.com/FirebirdSQL/firebird/issues/8675[#8675]_
-- _fbclient_ incompatible to older ODS  

_Implemented by Adriano dos Santos Fernandes_

'''

_https://github.com/FirebirdSQL/firebird/issues/8673[#8673]_
...
_https://github.com/FirebirdSQL/firebird/issues/8653[#8653]_
...
_https://github.com/FirebirdSQL/firebird/issues/8644[#8644]_
...
_https://github.com/FirebirdSQL/firebird/issues/8541[#8541]_
...
_https://github.com/FirebirdSQL/firebird/issues/8535[#8535]_
-- `OuterJoinConversion = true` (i.e. default) causes performance regression  

_Implemented by Dmitry Yemanov_

'''

_https://github.com/FirebirdSQL/firebird/issues/8105[#8105]_
...
_https://github.com/FirebirdSQL/firebird/issues/7916[#7916]_
...
_https://github.com/FirebirdSQL/firebird/pull/8674[#8674]_
-- Fix crash during shutdown after unsuccessful `ping()` call  

_Implemented by Dmitry Yemanov_

'''

_https://github.com/FirebirdSQL/firebird/pull/8666[#8666]_
...
[[bug-504-vulnerabilities]]
=== Vulnerabilities

_https://github.com/FirebirdSQL/firebird/security/advisories/GHSA-7pxc-h3rv-r257[GHSA-7pxc-h3rv-r257]_
-- Path traversal when declaring external routine (CVE-2026-40342)

_Implemented by VladimirEliTokarev, Alexander Peshkov_

'''

_https://github.com/FirebirdSQL/firebird/security/advisories/GHSA-g99w-prq5-29c6[GHSA-g99w-prq5-29c6]_
-- Denial-of-service (DoS) via malicious slice descriptor in the slice packet (CVE-2026-35215)

_Implemented by Artyom Ivanov, Alexander Peshkov_

'''

_https://github.com/FirebirdSQL/firebird/security/advisories/GHSA-7jq3-6j3c-5cm2[GHSA-7jq3-6j3c-5cm2]_
-- Denial-of-service (DoS) via `op_response` packet from client (CVE-2026-34232)

_Implemented by Artyom Ivanov_

'''

_https://github.com/FirebirdSQL/firebird/security/advisories/GHSA-89mq-229g-x47p[GHSA-89mq-229g-x47p]_
-- Buffer overflow on parsing corrupted slice packet (CVE-2026-33337)  

_Implemented by Artyom Ivanov_

'''

_https://github.com/FirebirdSQL/firebird/security/advisories/GHSA-xrcw-wpjx-pr9[GHSA-xrcw-wpjx-pr9]_
-- CryptCallback Denial-of-service (DoS) (CVE-2026-28224)

_Implemented by Ev3nt_

'''

_https://github.com/FirebirdSQL/firebird/security/advisories/GHSA-6crx-4g37-7j49[GHSA-6crx-4g37-7j49]_
-- Pre-Auth Denial-of-service (DoS) (CVE-2026-27890)

_Implemented by Artyom Ivanov_

'''

_https://github.com/FirebirdSQL/firebird/security/advisories/GHSA-7cq5-994r-jhrf[GHSA-7cq5-994r-jhrf]_
-- Server hangs when using specific clumplet on batch creation (CVE-2026-28214)  

_Implemented by Artyom Ivanov_

'''

_https://github.com/FirebirdSQL/firebird/security/advisories/GHSA-9884-9qm3-hqch[GHSA-9884-9qm3-hqch]_
-- One packet (`op_slice`) Denial-of-service (DoS) (CVE-2026-28212)

_Implemented by Alexey Mochalov_

'''

_https://github.com/FirebirdSQL/firebird/security/advisories/GHSA-mfpr-9886-xjhg[GHSA-mfpr-9886-xjhg]_
-- Information leak vulnerability in Firebird 3 client when used with newer (>= 4) server (CVE-2025-65104)
...
[[bug-504-utilities-isql]]
==== isql

_https://github.com/FirebirdSQL/firebird/issues/8690[#8690]_
-- On Windows 7 _isql_ exits silently right after the start  

_Implemented by Vlad Khorsun_

'''

_https://github.com/FirebirdSQL/firebird/issues/8665[#8665]_
...
[[bug-504-utilities-gbak]]
==== gbak

_https://github.com/FirebirdSQL/firebird/issues/8988[#8988]_
-- Parallel restore could use less active workers then it can  

_Implemented by Vlad Khorsun_

'''

_https://github.com/FirebirdSQL/firebird/pull/8815[#8815]_
-- Restore the broken record layout optimization by _gbak_ and extend it to the new datatypes  

_Implemented by Dmitry Yemanov_

'''

[[bug-504-utilities-gstat]]
==== gstat

_https://github.com/FirebirdSQL/firebird/issues/8828[#8828]_
-- _Gstat_ does not open database if the system locale is not UTF-8  

_Implemented by Vasiliy Yashkov_
