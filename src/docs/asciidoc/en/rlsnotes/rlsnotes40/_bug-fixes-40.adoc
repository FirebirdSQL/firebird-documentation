...
[[bug-407]]
== Firebird 4.0.7 Release: Bug Fixes
...
_https://github.com/FirebirdSQL/firebird/issues/8850[#8850]_
-- `KERNEL32.GetThreadId` import breaks Windows XP
