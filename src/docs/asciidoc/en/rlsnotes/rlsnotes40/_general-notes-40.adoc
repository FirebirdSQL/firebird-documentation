...
Thank you for reviewing Firebird 4.0 Release Candiatate 1.
...
Bugs fixed since Firebird 3.0.7 and Firebird 4.0 Beta 2 release are listed and described in the <<rnfb40-bug,Bugs Fixed>> chapter.
