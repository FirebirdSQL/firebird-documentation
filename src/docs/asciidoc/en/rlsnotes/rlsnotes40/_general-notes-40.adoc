...
Bugs reported and fixed prior to the version 4.0.7 release are listed <<bug-407,HERE>>.

[[rnfb40-general-improvements-v407]]
=== V.4.0.7 Improvements

_https://github.com/FirebirdSQL/firebird/pull/8922[#8922]_
...
For more details, see <<rnfb40-apiods-api-util-convert>>.
