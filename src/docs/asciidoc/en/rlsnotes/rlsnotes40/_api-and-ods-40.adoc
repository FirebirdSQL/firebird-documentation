...
The new method is added to the `Util` interface that converts values stored inside a message between different data types in the same way as the engine does it internally. It works for all data types except blobs and arrays.
