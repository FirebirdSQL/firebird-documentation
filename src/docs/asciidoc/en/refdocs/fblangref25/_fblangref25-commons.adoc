...
Context variable::
An internally-defined <<fblangref25-functions-contextvars,context variable>>
...
A _<step value>_ of 0 returns the current sequence value.
====
...
That is, it functions just like the '`[command]``=```' operator:
