...
[appendix]
[[fblangref25-appx01-supplement]]
= Supplementary Information

In this Appendix are topics that developers may wish to refer to, to enhance understanding of features or changes.

[[fblangref25-appx01-supp-rdb-validblr]]
== [[fblangref25-appx01-supp-rdb_validblr]]The `RDB$VALID_BLR` Field
...
[[fblangref25-appx01-note-on-equality]]
== A Note on Equality
