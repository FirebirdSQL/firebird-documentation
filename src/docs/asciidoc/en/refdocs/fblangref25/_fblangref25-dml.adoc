...
.See also
<<fblangref25-functions-scalarfuncs,Scalar Functions>>, <<fblangref25-functions-aggfuncs,Aggregate Functions>>, <<fblangref25-functions-contextvars,Context Variables>>, <<fblangref25-commons-conditional-case,`CASE`>>, <<fblangref25-commons-subqueries,Subqueries>>
...
// TODO This caution is incorrect, remove or maybe rewrite to its intention (whatever that is)?
[CAUTION]
====
