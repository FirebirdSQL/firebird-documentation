...
|10 Jun 2026
|MR
a|* Documented `RESTRICT` for `ALTER TABLE ... DROP _column_` (https://github.com/FirebirdSQL/firebird-documentation/issues/227[#227])
* Removed incorrect mention of decimal point in `FLOAT`
* Fixed wrong exponent used in range for `SMALLINT` and `INTEGER`
* Corrected documentation of `RDB$PROCEDURE_ARGUMENTS.{zwsp}RDB$PARAMETER_MECHANISM` (https://github.com/FirebirdSQL/firebird-documentation/issues/236[#236])
