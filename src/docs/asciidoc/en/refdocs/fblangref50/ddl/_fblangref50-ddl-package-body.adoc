...
.See also
<<fblangref50-ddl-pkg-body-drop>>, <<fblangref50-ddl-pkg-body-recreate>>, <<fblangref50-ddl-pkg-create,`CREATE PACKAGE`>>
...
.See also
<<fblangref50-ddl-pkg-body-create>>, <<fblangref50-ddl-pkg-body-recreate>>, <<fblangref50-ddl-pkg-drop,`DROP PACKAGE`>>
