...
For more information, see <<fblangref50-ddl-exception-create,`CREATE EXCEPTION`>> in [ref]_DDL Statements_ and, for usage, the statement <<fblangref50-psql-exception,`EXCEPTION`>> in  [ref]_PSQL Statements_.
====
...
[[fblangref50-appx02-tbl-sqlstates]]
