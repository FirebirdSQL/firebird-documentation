...
For more information, see <<fblangref50-ddl-exception-create,`CREATE EXCEPTION`>> in xref:fblangref50-ddl[] and, for usage, the statement <<fblangref50-psql-exception,`EXCEPTION`>> in xref:fblangref50-psql[].
====
