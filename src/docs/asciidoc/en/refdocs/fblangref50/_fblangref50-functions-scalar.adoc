...
See also <<fblangref50-management-setdecfloat,`SET DECFLOAT`>>.
...
.See also
<<fblangref50-scalarfuncs-reset-context>>, <<fblangref50-scalarfuncs-set-context>>

[#fblangref50-scalarfuncs-reset-context]
=== `RDB$RESET_CONTEXT()`
...
[[fblangref50-funcs-tbl-rdbresetcontext]]
...
.See also
<<fblangref50-scalarfuncs-get-context>>, <<fblangref50-scalarfuncs-set-context>>
...
* <<fblangref50-scalarfuncs-reset-context>> can be used to clear all variables from a context
* <<fblangref50-management-session-reset-alter,`ALTER SESSION RESET`>> clears both `USER_TRANSACTION` and `USER_SESSION` contexts.
====
...
.See also
<<fblangref50-scalarfuncs-get-context>>, <<fblangref50-scalarfuncs-reset-context>>
...
.See also
<<fblangref50-commons-concat,Concatenation Operator>>, <<fblangref50-aggfuncs-list,`LIST()`>>, <<fblangref50-sys-pckg-blobutil,`RDB$BLOB_UTIL`>>
...
[[fblangref50-functions-scalarfuncs-current-date]]
=== `CURRENT_DATE`

Documented in <<fblangref50-contextvars-current-date>>.

[[fblangref50-functions-scalarfuncs-current-time]]
=== `CURRENT_TIME`

Documented in <<fblangref50-contextvars-current-time>>.

[[fblangref50-functions-scalarfuncs-current-timestamp]]
=== `CURRENT_TIMESTAMP`

Documented in <<fblangref50-contextvars-current-timestamp>>.
...
[[fblangref50-functions-scalarfuncs-localtime]]
=== `LOCALTIME`

Documented in <<fblangref50-contextvars-localtime>>.

[[fblangref50-functions-scalarfuncs-localtimestamp]]
=== `LOCALTIMESTAMP`

Documented in <<fblangref50-contextvars-localtimestamp>>.
...
See the note <<fblangref50-appx01-supp-rdb-validblr,_The RDB$VALID_BLR field_>>, in Appendix A.
====
