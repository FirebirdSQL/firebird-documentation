...
For more information, see <<fblangref30-ddl-exception-create,`CREATE EXCEPTION`>> in [ref]_DDL Statements_ and, for usage, the statement <<fblangref30-psql-exception,`EXCEPTION`>> in  [ref]_PSQL Statements_.
====
...
[[fblangref30-appx02-tbl-sqlstates]]
...
[[fblangref30-appx02-tbl-errcodes01]]
