...
For more information, see <<fblangref40-ddl-exception-create,`CREATE EXCEPTION`>> in [ref]_DDL Statements_ and, for usage, the statement <<fblangref40-psql-exception,`EXCEPTION`>> in  [ref]_PSQL Statements_.
====
...
[[fblangref40-appx02-tbl-sqlstates]]
...
[[fblangref40-appx02-tbl-errcodes01]]
