...
This option can be specified for tables with a `GENERATED BY DEFAULT` and -- since Firebird 4.0.3 -- `GENERATED ALWAYS` identity column.
+
...
-- for both BY DEFAULT and - 4.0.3 or higher - ALWAYS
