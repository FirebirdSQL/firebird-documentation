...
[CAUTION]
====
Data type changed in Firebird 4 from `TIME WITHOUT TIME ZONE` to `TIME WITH TIME ZONE`.
...
[CAUTION]
====
Data type changed in Firebird 4 from `TIMESTAMP WITHOUT TIME ZONE` to `TIMESTAMP WITH TIME ZONE`.
