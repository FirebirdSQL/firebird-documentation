...
<declare-var> ::= !! See <<fblangref40-psql-declare-variable,DECLARE VARIABLE>> !!

<declare-cursor> ::= !! See <<fblangref40-psql-declare-cursor, DECLARE .. CURSOR>> !!

<declare-subfunc> ::= !! See <<fblangref40-psql-declfunc,DECLARE FUNCTION>> !!

<declare-subproc>> ::= !! See <<fblangref40-psql-declproc,DECLARE PROCEDURE>> !!
----
