...
[[fblangref40-security-mapping-rule]]
== The Mapping Rule
...
[[fblangref40-security-mapping-create]]
== `CREATE MAPPING`
...
[[fblangref40-security-mapping-tbl-createmapping]]
...
The mapped role can be assumed later in the session using <<fblangref40-management-role-set-trusted,`SET TRUSTED ROLE`>>, even when the mapped role is not explicitly granted to the user.

[[fblangref40-security-mapping-create-who]]
...
[[fblangref40-security-mapping-create-exmpl]]
...
.See also
<<fblangref40-security-mapping-alter>>, <<fblangref40-security-mapping-createoralter>>, <<fblangref40-security-mapping-drop>>

[[fblangref40-security-mapping-alter]]
== `ALTER MAPPING`
...
For details on the options, see <<fblangref40-security-mapping-create>>.
...
[[fblangref40-security-mapping-alter-who]]
...
[[fblangref40-security-mapping-alter-exmpl]]
...
.See also
<<fblangref40-security-mapping-create>>, <<fblangref40-security-mapping-createoralter>>, <<fblangref40-security-mapping-drop>>

[[fblangref40-security-mapping-createoralter]]
...
[[fblangref40-security-mapping-createoralter-exmpl]]
...
.See also
<<fblangref40-security-mapping-create>>, <<fblangref40-security-mapping-alter>>, <<fblangref40-security-mapping-drop>>

[[fblangref40-security-mapping-drop]]
== `DROP MAPPING`
...
[[fblangref40-security-mapping-tbl-dropmapping]]
...
[[fblangref40-security-mapping-drop-who]]
...
[[fblangref40-security-mapping-drop-exmpl]]
