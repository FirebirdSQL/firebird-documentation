...
[[fblangref30-security-dbcrypt-encrypt]]
...
[[fblangref30-security-tbl-encrypt]]
...
.See also
<<fblangref30-security-dbcrypt-decrypt>>, <<fblangref30-ddl-tbl-alterdatabase,`ALTER DATABASE`>>

[[fblangref30-security-dbcrypt-decrypt]]
...
.See also
<<fblangref30-security-dbcrypt-encrypt>>, <<fblangref30-ddl-tbl-alterdatabase,`ALTER DATABASE`>>
