...
`CLIENT_OS_USER`::
OS username reported by the client (since 4.0.4).
...
`CLIENT_VERSION`::
Client version information (since 4.0.4).
...
[[fblangref40-functions-scalarfuncs-current-date]]
=== `CURRENT_DATE`

Documented in <<fblangref40-contextvars-current-date>>.

[[fblangref40-functions-scalarfuncs-current-time]]
=== `CURRENT_TIME`

Documented in <<fblangref40-contextvars-current-time>>.

[[fblangref40-functions-scalarfuncs-current-timestamp]]
=== `CURRENT_TIMESTAMP`

Documented in <<fblangref40-contextvars-current-timestamp>>.
...
[[fblangref40-functions-scalarfuncs-localtime]]
=== `LOCALTIME`

Documented in <<fblangref40-contextvars-localtime>>.

[[fblangref40-functions-scalarfuncs-localtimestamp]]
=== `LOCALTIMESTAMP`

Documented in <<fblangref40-contextvars-localtimestamp>>.
