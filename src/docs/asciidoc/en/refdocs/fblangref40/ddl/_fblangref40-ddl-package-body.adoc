...
.See also
<<fblangref40-ddl-pkg-body-drop>>, <<fblangref40-ddl-pkg-body-recreate>>, <<fblangref40-ddl-pkg-create,`CREATE PACKAGE`>>
...
.See also
<<fblangref40-ddl-pkg-body-create>>, <<fblangref40-ddl-pkg-body-recreate>>, <<fblangref40-ddl-pkg-drop,`DROP PACKAGE`>>
