...
.See also
<<fblangref30-ddl-pkg-body-alter>>, <<fblangref30-ddl-pkg-body-drop>>, <<fblangref30-ddl-pkg-body-recreate>>, <<fblangref30-ddl-pkg-create,`CREATE PACKAGE`>>

[[fblangref30-ddl-pkg-body-alter]]
== `ALTER PACKAGE BODY`
...
[[fblangref30-ddl-pkg-body-alter-who]]
...
[[fblangref30-ddl-pkg-body-alter-example]]
...
.See also
<<fblangref30-ddl-pkg-body-create>>, <<fblangref30-ddl-pkg-body-alter>>, <<fblangref30-ddl-pkg-drop,`DROP PACKAGE`>>
...
.See also
<<fblangref30-ddl-pkg-body-create>>, <<fblangref30-ddl-pkg-body-alter>>, <<fblangref30-ddl-pkg-body-drop>>, <<fblangref30-ddl-pkg-alter,`ALTER PACKAGE`>>
