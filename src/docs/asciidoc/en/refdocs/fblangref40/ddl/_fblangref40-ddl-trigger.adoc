...
See <<fblangref40-psql-elements-body,The Module Body>> in the PSQL chapter for details.
...
!! See syntax of <<fblangref40-ddl-trgr-create-syntax,`CREATE TRIGGER`>> for further rules !!
----
