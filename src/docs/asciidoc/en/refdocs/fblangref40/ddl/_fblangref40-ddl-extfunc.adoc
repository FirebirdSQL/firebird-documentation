...
See <<fblangref30-ddl-func-create,`CREATE FUNCTION`>> for details.
====
...
We recommend avoiding their use whenever possible, and disabling UDFs in your database configuration (`UdfAccess = None` in `firebird.conf`).
If you do need to call native code from your database, use a UDR external engine instead.
====

.See also
<<fblangref30-ddl-function,`FUNCTION`>>

[[fblangref30-ddl-extfunc-declare]]
...
[[fblangref30-ddl-tbl-declarefunc]]
...
[[fblangref30-ddl-extfunc-keywords]]
...
[[fblangref30-ddl-extfunc-create-who]]
...
.See also
<<fblangref30-ddl-extfunc-alter>>, <<fblangref30-ddl-extfunc-drop>>, <<fblangref30-ddl-func-create,`CREATE FUNCTION`>>

[[fblangref30-ddl-extfunc-alter]]
...
[[fblangref30-ddl-extfunc-alter-who]]
...
[[fblangref30-ddl-extfunc-alter-example]]
...
.See also
<<fblangref30-ddl-extfunc-declare>>, <<fblangref30-ddl-extfunc-drop>>

[[fblangref30-ddl-extfunc-drop]]
...
[[fblangref30-ddl-tbl-dropextfunc]]
...
[[fblangref30-ddl-extfunc-drop-who]]
...
[[fblangref30-ddl-extfunc-drop-example]]
