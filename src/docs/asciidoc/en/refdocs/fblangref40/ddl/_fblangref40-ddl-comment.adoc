...
[[fblangref30-ddl-comment-create]]
== `COMMENT ON`
...
[WARNING]
====
Comments on users are visible to that user through the <<fblangref30-appx06-users,`SEC$USERS`>> virtual table.
====

[[fblangref30-ddl-comment-createpriv]]
...
[[fblangref30-ddl-comment-create-exmpl]]
