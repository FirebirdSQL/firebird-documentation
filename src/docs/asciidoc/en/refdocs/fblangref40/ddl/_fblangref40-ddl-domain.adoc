...
A detailed description of domains and their usage can be found in <<fblangref40-datatypes-custom,Custom Data Types -- Domains>>.

[[fblangref40-ddl-domn-create]]
== `CREATE DOMAIN`
...
[[fblangref40-ddl-domn-create-syntax]]
.Syntax
...
[[fblangref40-ddl-tbl-createdomn]]
...
[[fblangref40-ddl-domn-create-who]]
...
[[fblangref40-ddl-createdomnexmpls]]
...
.See also
<<fblangref40-ddl-domn-alter>>, <<fblangref40-ddl-domn-drop>>

[[fblangref40-ddl-domn-alter]]
== `ALTER DOMAIN`
...
!! See also <<fblangref40-ddl-domn-create-syntax,`CREATE DOMAIN` Syntax>> !!
----

[[fblangref40-ddl-tbl-alterdomn]]
...
[[fblangref40-ddl-domn-alter-opts]]
...
For information on how to detect it, read the piece entitled <<fblangref40-appx01-supp-rdb-validblr,[ref]_The RDB$VALID_BLR Field_>> in Appendix A.
====

[[fblangref40-ddl-domn-cannotalter]]
...
[[fblangref40-ddl-domn-alter-who]]
...
[[fblangref40-ddl-domn-alterdomnexmpls]]
...
.See also
<<fblangref40-ddl-domn-create>>, <<fblangref40-ddl-domn-drop>>

[[fblangref40-ddl-domn-drop]]
== `DROP DOMAIN`
...
[[fblangref40-ddl-domn-drop-example]]
...
.See also
<<fblangref40-ddl-domn-create>>, <<fblangref40-ddl-domn-alter>>
