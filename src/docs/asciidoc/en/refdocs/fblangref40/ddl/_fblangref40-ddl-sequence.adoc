...
The optional `INCREMENT [BY]` clause allows you to specify an increment for the <<fblangref40-commons-conditional-nxtvlufor,`NEXT VALUE FOR _seq_name_`>> expression.
...
.See also
<<fblangref40-ddl-sequence-alter>>, <<fblangref40-ddl-sequence-crtoralt>>, <<fblangref40-ddl-sequence-drop>>, <<fblangref40-ddl-sequence-recr>>, <<fblangref40-ddl-sequence-setgen>>, <<fblangref40-commons-conditional-nxtvlufor,`NEXT VALUE FOR`>>, <<fblangref40-scalarfuncs-gen-id,`GEN_ID() function`>>
...
.See also
<<fblangref40-ddl-sequence-setgen>>, <<fblangref40-ddl-sequence-create>>, <<fblangref40-ddl-sequence-crtoralt>>, <<fblangref40-ddl-sequence-drop>>, <<fblangref40-ddl-sequence-recr>>, <<fblangref40-commons-conditional-nxtvlufor,`NEXT VALUE FOR`>>, <<fblangref40-scalarfuncs-gen-id,`GEN_ID() function`>>
...
.See also
<<fblangref40-ddl-sequence-create>>, <<fblangref40-ddl-sequence-alter>>, <<fblangref40-ddl-sequence-drop>>, <<fblangref40-ddl-sequence-recr>>, <<fblangref40-ddl-sequence-setgen>>, <<fblangref40-commons-conditional-nxtvlufor,`NEXT VALUE FOR`>>, <<fblangref40-scalarfuncs-gen-id,`GEN_ID() function`>>
...
.See also
<<fblangref40-ddl-sequence-create>>, <<fblangref40-ddl-sequence-alter>>, <<fblangref40-ddl-sequence-crtoralt>>, <<fblangref40-ddl-sequence-drop>>, <<fblangref40-ddl-sequence-setgen>>, <<fblangref40-commons-conditional-nxtvlufor,`NEXT VALUE FOR`>>, <<fblangref40-scalarfuncs-gen-id,`GEN_ID() function`>>
...
.See also
<<fblangref40-ddl-sequence-alter>>, <<fblangref40-ddl-sequence-create>>, <<fblangref40-ddl-sequence-crtoralt>>, <<fblangref40-ddl-sequence-drop>>, <<fblangref40-commons-conditional-nxtvlufor,`NEXT VALUE FOR`>>, <<fblangref40-scalarfuncs-gen-id,`GEN_ID() function`>>
