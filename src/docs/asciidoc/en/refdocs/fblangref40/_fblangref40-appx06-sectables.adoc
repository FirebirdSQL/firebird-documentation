...
[[fblangref40-appx06-tbl-dbcreators]]
...
// Keep column description in-sync with fblangref40-appx04-tbl-authmapping

[[fblangref40-appx06-tbl-authmapping]]
[cols="<4m,<3m,<5", frame="all", options="header",stripes="none"]
|===
^| Column Name
^| Data Type
...
[[fblangref40-appx06-userattr]]
== `SEC$USER_ATTRIBUTES`

Additional attributes of users

[[fblangref40-appx06-tbl-userattr]]
[cols="<4m,<3m,<5", frame="all", options="header",stripes="none"]
|===
^| Column Name
^| Data Type
