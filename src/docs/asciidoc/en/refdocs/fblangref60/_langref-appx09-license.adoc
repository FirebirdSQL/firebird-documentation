...
The Original Documentation is titled _Firebird 6.0 Language Reference_.
This Documentation was derived from _Firebird 5.0 Language Reference_.
...
Included portions are Copyright (C) 2001-2026 by their respective authors.
All Rights Reserved.

Contributor(s): Mark Rotteveel.

Portions created by Mark Rotteveel are Copyright (C) 2018-2026.
All Rights Reserved.
