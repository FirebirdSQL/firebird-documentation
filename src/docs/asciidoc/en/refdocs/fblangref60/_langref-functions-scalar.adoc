...
<<langref-scalarfuncs-maxvalue>> is a non-standard alias for `GREATEST()`.
...
.See also
<<langref-scalarfuncs-least>>, <<langref-scalarfuncs-maxvalue>>, <<langref-scalarfuncs-minvalue>>
...
<<langref-scalarfuncs-minvalue>> is a non-standard alias for `LEAST()`.
...
.See also
<<langref-scalarfuncs-greatest>>, <<langref-scalarfuncs-maxvalue>>, <<langref-scalarfuncs-minvalue>>
...
`MAXVALUE()` is a non-standard alias for <<langref-scalarfuncs-greatest>>.
...
.See also
<<langref-scalarfuncs-greatest>>, <<langref-scalarfuncs-least>>, <<langref-scalarfuncs-minvalue>>
...
`MINVALUE()` is a non-standard alias for <<langref-scalarfuncs-least>>.
...
.See also
<<langref-scalarfuncs-greatest>>, <<langref-scalarfuncs-least>>, <<langref-scalarfuncs-maxvalue>>
