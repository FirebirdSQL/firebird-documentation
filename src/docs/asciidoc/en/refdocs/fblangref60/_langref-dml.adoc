...
.Syntax
[listing#langref-dml-select-from-syntax,subs="+quotes,macros"]
----
SELECT
  ...
  FROM <table-reference> [, <table-reference> ...]
...
<built-in-table-function> ::=
  !! See <<langref-table-valued-func, Built-in Table-valued Functions>> !!
...
.Syntax
[listing#langref-dml-select-orderby-syntax]
----
SELECT ... FROM ...
...
