...
This Firebird 6.0 Language Reference covers all aspects of the SQL query language used by developers to communicate, through their applications, with version 6.0 of the Firebird relational database management system.

[#langref-intro-subject]
== Subject

The subject of this manual is Firebird's implementation of the SQL ("`Structured Query Language`") relational database language.
