...
.See also
<<langref-psql-ifthen>>, <<langref-psql-break>>, <<langref-psql-leave>>, <<langref-psql-continue>>, <<langref-psql-exit>>, <<langref-psql-forselect>>, <<langref-psql-forexec>>
...
.See also
<<langref-psql-declare-cursor>>, <<langref-psql-break>>, <<langref-psql-leave>>, <<langref-psql-continue>>, <<langref-psql-exit>>, <<langref-dml-select,`SELECT`>>, <<langref-dml-update,`UPDATE`>>, <<langref-dml-delete,`DELETE`>>
...
.See also
<<langref-psql-execstmt>>, <<langref-psql-break>>, <<langref-psql-leave>>, <<langref-psql-continue>>
