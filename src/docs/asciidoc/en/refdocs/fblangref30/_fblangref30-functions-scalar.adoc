...
[[fblangref30-functions-scalarfuncs-current-date]]
=== `CURRENT_DATE`

Documented in <<fblangref30-contextvars-current-date>>.

[[fblangref30-functions-scalarfuncs-current-time]]
=== `CURRENT_TIME`

Documented in <<fblangref30-contextvars-current-time>>.

[[fblangref30-functions-scalarfuncs-current-timestamp]]
=== `CURRENT_TIMESTAMP`

Documented in <<fblangref30-contextvars-current-timestamp>>.
...
.Result type
`BIGINT`, or -- since Firebird 3.0.8 -- `NUMERIC(18,1)` for `MILLISECOND`
...
[[fblangref30-functions-scalarfuncs-localtime]]
=== `LOCALTIME`

Documented in <<fblangref30-contextvars-localtime>>.

[[fblangref30-functions-scalarfuncs-localtimestamp]]
=== `LOCALTIMESTAMP`

Documented in <<fblangref30-contextvars-localtimestamp>>.
