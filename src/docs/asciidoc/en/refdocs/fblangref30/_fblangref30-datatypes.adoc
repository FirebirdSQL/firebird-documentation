...
[[fblangref30-datatypes-inttypes]]
== Integer Data Types
...
[[fblangref30-datatypes-smallint]]
=== `SMALLINT`
...
The usage and numerical value ranges of hexadecimal notation are described in more detail in the discussion of <<fblangref30-commons-number-constant,number constants>> in the chapter entitled [ref]_Common Language Elements_.
...
[[fblangref30-datatypes-floattypes]]
...
[[fblangref30-datatypes-float]]
=== `FLOAT`

The `FLOAT` data type has an approximate precision of 7 digits.
To ensure the safety of storage, rely on 6 digits.

[[fblangref30-datatypes-double]]
=== `DOUBLE PRECISION`

The `DOUBLE PRECISION` data type is stored with an approximate precision of 15 digits.

[[fblangref30-datatypes-fixedtypes]]
...
[[fblangref30-datatypes-numerictbl]]
...
[[fblangref30-datatypes-decimaltbl]]
...
[[fblangref30-datatypes-datetime]]
...
See also the <<fblangref30-scalarfuncs-extract,`EXTRACT()` function>> in the chapter entitled [ref]_Built-in Functions_.

[[fblangref30-datatypes-timestamp]]
=== `TIMESTAMP`
...
[[fblangref30-datatypes-datetimeops]]
...
.See also
<<fblangref30-scalarfuncs-dateadd,`DATEADD`>>, <<fblangref30-scalarfuncs-datediff,`DATEDIFF`>>

[[fblangref30-datatypes-chartypes]]
...
[[fblangref30-datatypes-chartypes-unicode]]
=== Unicode
...
[[fblangref30-datatypes-chartypes-client]]
...
[[fblangref30-datatypes-chartypes-special]]
...
[[fblangref30-datatypes-chartypes-collation]]
=== Collation Sequence
...
[[fblangref30-datatypes-chartypes-caseinsenstv]]
...
.See also
<<fblangref30-commons-predcontaining,`CONTAINING`>>

[[fblangref30-datatypes-chartypes-utf8collations]]
==== `UTF8` Collation Sequences

The following table shows the possible collation sequences for the `UTF8` character set.

[[fblangref30-dtyp-tbl-utfcollats]]
...
[[fblangref30-datatypes-chartypes-charindxs]]
=== Character Indexes
...
[[fblangref30-dtyp-tbl-charindxsz]]
...
.See also
<<fblangref30-ddl-db-create,`CREATE DATABASE`>>, <<fblangref30-datatypes-chartypes-collation,Collation sequence>>, <<fblangref30-dml-select,`SELECT`>>, <<fblangref30-dml-select-where,`WHERE`>>, <<fblangref30-dml-select-groupby,`GROUP BY`>>, <<fblangref30-dml-select-orderby,`ORDER BY`>>

[[fblangref30-datatypes-chartypes-detail]]
=== Character Types in Detail

[[fblangref30-datatypes-chartypes-char]]
==== `CHAR`
...
[[fblangref30-datatypes-chartypes-varchar]]
==== `VARCHAR`
...
[[fblangref30-datatypes-chartypes-nchar]]
==== `NCHAR`
...
[[fblangref30-datatypes-booleantypes]]
== Boolean Data Type

Firebird 3.0 introduced a fully-fledged Boolean data type.

[[fblangref30-datatypes-boolean]]
=== `BOOLEAN`
...
[[fblangref30-datatypes-boolean-is]]
==== The IS Operator

Predicates can use the operator <<fblangref30-commons-isnotboolean,Boolean `IS [NOT]`>> for matching.
...
[[fblangref30-datatypes-boolean-examples]]
==== `BOOLEAN` Examples
...
[[fblangref30-datatypes-boolean-othertypes]]
...
[[fblangref30-datatypes-bnrytypes]]
== Binary Data Types
...
[[fblangref30-datatypes-seg-size]]
.Segment Size
[sidebar]
...
[[fblangref30-datatypes-bnrytypes-sub]]
=== `BLOB` Subtypes
...
[[fblangref30-datatypes-bnrytypes-more]]
=== `BLOB` Specifics
...
.See also
<<fblangref30-ddl-filter,`FILTER`>>, <<fblangref30-ddl-filter-declare,`DECLARE FILTER`>>

[[fblangref30-datatypes-array]]
=== `ARRAY` Type
...
[[fblangref30-datatypes-array-bounds]]
...
[[fblangref30-datatypes-array-adddim]]
...
[[fblangref30-datatypes-special]]
== Special Data Types

"`Special`" data types ...

[[fblangref30-datatypes-special-sqlnull]]
=== `SQL_NULL` Data Type
...
[[fblangref30-datatypes-conversion]]
...
[[fblangref30-datatypes-convert-explicit]]
...
See also <<fblangref30-scalarfuncs-cast,`CAST()`>> in Chapter _Built-in Scalar Functions_.

[[fblangref30-datatypes-convert-domain]]
==== Casting to a Domain
...
[[fblangref30-datatypes-convert-typeof]]
...
[[fblangref30-datatypes-convert-conversions]]
==== Conversions Possible for the `CAST` Function

[[fblangref30-dtyp-tbl-conversions]]
...
[[fblangref30-datatypes-convert-literalformats]]
==== Literal Formats

To cast string data types to the `DATE`, `TIME` or `TIMESTAMP` data types, you need the string argument to be one of the predefined date and time literals (see xref:fblangref30-dtyp-tbl-keydesc[xrefstyle="short"]) or a representation of the date in one of the allowed _date-time literal_ formats:
...
[[fblangref30-dtyp-tbl-predliterals]]
...
[[fblangref30-datatypes-convert-shortcasts]]
...
[[fblangref30-datatypes-convert-implicit]]
...
[[fblangref30-datatypes-convert-implicit-concat]]
...
[[fblangref30-datatypes-domainattribs]]
=== Domain Attributes
...
.See also
<<fblangref30-datatypes-convert-typeof,Explicit Data Type Conversion>> for the description of differences in the data conversion mechanism when domains are specified for the `TYPE OF` and `TYPE OF COLUMN` modifiers.

[[fblangref30-datatypes-domainoverride]]
=== Domain Override
...
[[fblangref30-dtyp-tbl-domoverride]]
...
[[fblangref30-datatypes-domaincreate]]
...
.See also
<<fblangref30-ddl-domn-create,`CREATE DOMAIN`>> in the Data Definition Language (DDL) section.

[[fblangref30-datatypes-domainalter]]
==== Altering a Domain
...
.See also
<<fblangref30-ddl-domn-alter,`ALTER DOMAIN`>> in the Data Definition Language (DDL) section.

[[fblangref30-datatypes-domaindrop]]
...
.See also
<<fblangref30-ddl-domn-drop,`DROP DOMAIN`>> in the Data Definition Language (DDL) section.

[[fblangref30-datatypes-syntax]]
== Data Type Declaration Syntax

This section documents the syntax of declaring data types.
Data type declaration most commonly occurs in <<fblangref30-ddl,DDL statements>>, but also in <<fblangref30-datatypes-convert-explicit,`CAST`>> and <<fblangref30-dml-execblock,`EXECUTE BLOCK`>>.

The syntax documented below is referenced from other parts of this language reference.

[[fblangref30-datatypes-syntax-scalar]]
=== Scalar Data Types Syntax

The scalar data types are simple data types that hold a single value.
For reasons of organisation, the syntax of BLOB types are defined separately in <<fblangref30-datatypes-syntax-blob>>.

[[fblangref30-datatypes-syntax-scalar-syntax]]
.Scalar Data Types Syntax
[listing,subs=+quotes]
----
<domain_or_non_array_type> ::=
...
[[fblangref30-datatypes-tbl-scalar-syntax]]
...
[[fblangref30-datatypes-syntax-scalar-domns]]
...
[[fblangref30-ddl-func-paramscoltype]]
...
[[fblangref30-datatypes-syntax-blob]]
=== BLOB Data Types Syntax

The BLOB data types hold binary, character or custom format data of unspecified size.
For more information, see <<fblangref30-datatypes-bnrytypes>>.

[[fblangref30-datatypes-syntax-blob-syntax]]
.BLOB Data Types Syntax
[listing,subs=+quotes]
----
<blob_datatype> ::=
...
[[fblangref30-datatypes-tbl-blob-syntax]]
...
See also <<fblangref30-datatypes-seg-size>>
|===

[[fblangref30-datatypes-syntax-array]]
=== Array Data Types Syntax

The array data types hold multiple scalar values in a single or multi-dimensional array.
For more information, see <<fblangref30-datatypes-array>>

[[fblangref30-datatypes-syntax-array-syntax]]
.Array Data Types Syntax
[listing,subs="+quotes,attributes"]
----
<array_datatype> ::=
...
[[fblangref30-datatypes-tbl-array-syntax]]
