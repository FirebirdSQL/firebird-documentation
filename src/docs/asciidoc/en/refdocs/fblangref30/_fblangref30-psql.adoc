...
For information on modifying existing package header or bodies, see <<fblangref30-ddl-pkg-alter,`ALTER PACKAGE`>>, <<fblangref30-ddl-pkg-createalter,`CREATE OR ALTER PACKAGE`>>, <<fblangref30-ddl-pkg-recreate,`RECREATE PACKAGE`>>, <<fblangref30-ddl-pkg-body-alter,`ALTER PACKAGE BODY`>>, <<fblangref30-ddl-pkg-body-recreate,`RECREATE PACKAGE BODY`>>
...
.See also
<<fblangref30-psql-exit>>, <<fblangref30-sidebar01,`SET TERM`>>
