...
[[fblangref30-psql-elements-transacs]]
=== Transactions
...
[[fblangref30-psql-elements-structure]]
=== Module Structure
...
[[fblangref30-psql-elements-header]]
==== The Module Header
...
[[fblangref30-psql-elements-tbl-body]]
...
[[fblangref30-psql-elements-body-psql]]
...
[[fblangref30-psql-elements-body-ext]]
...
[[fblangref30-psql-storedprocs-benefits]]
...
See <<create-procedure-examples,an example of an executable stored procedure>> at the end of the <<fblangref30-ddl-proc-create,`CREATE PROCEDURE` section>> of Chapter 5.

[[fblangref30-psql-storedprocs-selectable]]
...
A <<fblangref30-psql-suspend,`SUSPEND`>> statement at the end of the iteration fills the buffer and waits for the caller to fetch the row.
...
See <<create-procedure-examples,an example of a selectable stored procedure>> at the end of the <<fblangref30-ddl-proc-create,`CREATE PROCEDURE` section>> of Chapter 5.

[[fblangref30-psql-storedprocs-creating]]
...
For information about creating stored procedures, see <<fblangref30-ddl-proc-create,`CREATE PROCEDURE`>> in Chapter _Data Definition (DDL) Statements_.

[[fblangref30-psql-storedprocs-modifying]]
=== Modifying a Stored Procedure

For information about modifying existing stored procedures, see <<fblangref30-ddl-proc-alter,`ALTER PROCEDURE`>>, <<fblangref30-ddl-proc-crtoralter,`CREATE OR ALTER PROCEDURE`>>, <<fblangref30-ddl-proc-recreate,`RECREATE PROCEDURE`>>, in Chapter _Data Definition (DDL) Statements_.

[[fblangref30-psql-storedprocs-deleting]]
=== Deleting a Stored Procedure

For information about deleting stored procedures, see <<fblangref30-ddl-proc-drop,`DROP PROCEDURE`>> in Chapter _Data Definition (DDL) Statements_.

[[fblangref30-psql-storedfuncs]]
== Stored Functions
...
[[fblangref30-psql-storedfuncs-create]]
=== Creating a Stored Function

For information about creating stored functions, see <<fblangref30-ddl-func-create,`CREATE FUNCTION`>> in Chapter _Data Definition (DDL) Statements_.

[[fblangref30-psql-storedfuncs-modifying]]
=== Modifying a Stored Function

For information about modifying stored functions, see <<fblangref30-ddl-func-alter,`ALTER FUNCTION`>>, <<fblangref30-ddl-func-creatalter,`CREATE OR ALTER FUNCTION`>>, <<fblangref30-ddl-func-recreate,`RECREATE FUNCTION`>>, in Chapter _Data Definition (DDL) Statements_.

[[fblangref30-psql-storedfuncs-deleting]]
=== Deleting a Stored Function

For information about deleting stored procedures, see <<fblangref30-ddl-func-drop,`DROP FUNCTION`>> in Chapter _Data Definition (DDL) Statements_.

[[fblangref30-psql-dynblocks]]
== PSQL Blocks
...
.See also
See <<fblangref30-dml-execblock,`EXECUTE BLOCK`>> for details.

[[fblangref30-psql-package]]
== Packages
...
[[fblangref30-psql-pkg-create]]
=== Creating a Package

For information on creating packages, see <<fblangref30-ddl-pkg-create,`CREATE PACKAGE`>>, <<fblangref30-ddl-pkg-body-create,`CREATE PACKAGE BODY`>>

[[fblangref30-psql-pkg-alter]]
=== Modifying a Package

For information on modifying existing package header or bodies, see <<fblangref30-ddl-pkg-alter,`ALTER PACKAGE`>>, <<fblangref30-ddl-pkg-createalter,`CREATE OR ALTER PACKAGE`>>, <<fblangref30-ddl-pkg-recreate,`RECREATE PACKAGE`>>, <<fblangref30-ddl-pkg-body-recreate,`RECREATE PACKAGE BODY`>>

[[fblangref30-psql-pkg-drop]]
=== Deleting a Package

For information on deleting a package, see <<fblangref30-ddl-pkg-drop,`DROP PACKAGE`>>, <<fblangref30-ddl-pkg-body-drop,`DROP PACKAGE BODY`>>

[[fblangref30-psql-triggers]]
== Triggers
...
[[fblangref30-psql-triggeroptions]]
==== Trigger Options
...
The Boolean context variables <<fblangref30-contextvars-inserting,`INSERTING`>>, <<fblangref30-contextvars-updating,`UPDATING`>> and <<fblangref30-contextvars-deleting,`DELETING`>> can be used in the body of a trigger to determine the type of event that fired the trigger.

[[fblangref30-psql-oldnew]]
...
[[fblangref30-psql-ddltriggers-sem]]
==== Semantics
...
[[fblangref30-psql-ddltriggers-ctx]]
...
See also <<fblangref30-funcs-tbl-rdbgetcontext-ddl-trigger,The `DDL_TRIGGER` Namespace>> in <<fblangref30-scalarfuncs-get-context,`RDB$GET_CONTEXT`>> in Chapter _Built-in Scalar Functions_.

[[fblangref30-psql-triggercreate]]
=== Creating Triggers

For information on creating triggers, see <<fblangref30-ddl-trgr-create,`CREATE TRIGGER`>>, <<fblangref30-ddl-trgr-crtalter,`CREATE OR ALTER TRIGGER`>>, <<fblangref30-ddl-trgr-recreate,`RECREATE TRIGGER`>> in Chapter _Data Definition (DDL) Statements_.

[[fblangref30-psql-triggermodify]]
=== Modifying Triggers

For information on modifying triggers, see <<fblangref30-ddl-trgr-alter,`ALTER TRIGGER`>>, <<fblangref30-ddl-trgr-crtalter,`CREATE OR ALTER TRIGGER`>>, <<fblangref30-ddl-trgr-recreate,`RECREATE TRIGGER`>> in Chapter _Data Definition (DDL) Statements_.

[[fblangref30-psql-triggerdelete]]
=== Deleting a Trigger

For information on deleting triggers, see <<fblangref30-ddl-trgr-drop,`DROP TRIGGER`>> in Chapter _Data Definition (DDL) Statements_.

[[fblangref30-psql-coding]]
...
[[fblangref30-psql-coding-assign]]
...
[[fblangref30-psql-coding-assign-exmpl]]
...
.See also
<<fblangref30-psql-declare-variable>>
...
[NOTE]
====
A special case of `DECLARE [VARIABLE]` -- declaring cursors -- is covered separately in <<fblangref30-psql-declare-cursor>>
====

[[fblangref30-psql-variable-type]]
...
[[fblangref30-psql-variable-notnull]]
==== `NOT NULL` Constraint
...
[[fblangref30-psql-variable-charsetcollate]]
...
[[fblangref30-psql-variable-default]]
...
[[fblangref30-psql-variable-exmpl]]
...
.See also
<<fblangref30-datatypes,Data Types and Subtypes>>, <<fblangref30-datatypes-custom,Custom Data Types -- Domains>>, <<fblangref30-ddl-domn-create,`CREATE DOMAIN`>>

[[fblangref30-psql-declare-cursor]]
=== `DECLARE .. CURSOR`
...
[[fblangref30-psql-tbl-declare-cursor]]
...
[NOTE]
====
Syntactically, the `DECLARE ... CURSOR` statement is a special case of <<fblangref30-psql-declare-variable>>.
====
...
[[fblangref30-psql-cursor-examples]]
...
.See also
<<fblangref30-psql-open>>, <<fblangref30-psql-fetch>>, <<fblangref30-psql-close>>

[[fblangref30-psql-declfunc]]
=== `DECLARE FUNCTION`
...
<in_params> ::=
  !! See <<fblangref30-ddl-func-create-syntax,`CREATE FUNCTION` Syntax>> !!
...
[[fblangref30-psql-declfunc-exmpl]]
...
.See also
<<fblangref30-psql-declproc>>, <<fblangref30-ddl-func-create,`CREATE FUNCTION`>>

[[fblangref30-psql-declproc]]
=== `DECLARE PROCEDURE`
...
<in_params> ::=
  !! See <<fblangref30-ddl-proc-create-syntax,`CREATE PROCEDURE` Syntax>> !!
...
[[fblangref30-psql-tbl-declare-proc]]
...
[[fblangref30-psql-subrpoc-exmpl]]
...
.See also
<<fblangref30-psql-declfunc>>, <<fblangref30-ddl-proc-create,`CREATE PROCEDURE`>>

[[fblangref30-psql-beginend]]
=== `BEGIN ... END`
...
<when_do> ::=
  !! See <<fblangref30-psql-when,WHEN ... DO>> !!
----
...
For <<fblangref30-psql-handleexceptions,error handling>>, you can add one or more <<fblangref30-psql-when>> statements immediately before `END`.
...
[[fblangref30-psql-beginend-exmpl]]
==== `BEGIN ... END` Examples
...
.See also
<<fblangref30-psql-exit>>, <<fblangref30-sidebar01,`SET TERM`>>, <<fblangref30-psql-when>>

[[fblangref30-psql-ifthen]]
=== `IF ... THEN ... ELSE`
...
----
+
This specific example can be replaced with a <<fblangref30-commons-conditional-case-simple,simple `CASE`>> or the <<fblangref30-scalarfuncs-decode,`DECODE`>> function.

.See also
<<fblangref30-psql-while>>, <<fblangref30-commons-conditional-case,`CASE`>>

[[fblangref30-psql-while]]
=== `WHILE ... DO`
...
.See also
<<fblangref30-psql-ifthen>>, <<fblangref30-psql-break>>, <<fblangref30-psql-leave>>, <<fblangref30-psql-continue>>, <<fblangref30-psql-exit>>, <<fblangref30-psql-forselect>>, <<fblangref30-psql-forexec>>

[[fblangref30-psql-break]]
=== `BREAK`
...
.See also
<<fblangref30-psql-break>>, <<fblangref30-psql-continue>>, <<fblangref30-psql-exit>>

[[fblangref30-psql-continue]]
=== `CONTINUE`
...
.See also
<<fblangref30-psql-break>>, <<fblangref30-psql-leave>>, <<fblangref30-psql-exit>>

[[fblangref30-psql-exit]]
=== `EXIT`
...
.See also
<<fblangref30-psql-break>>, <<fblangref30-psql-leave>>, <<fblangref30-psql-continue>>, <<fblangref30-psql-suspend>>

[[fblangref30-psql-suspend]]
=== `SUSPEND`
...
The `SUSPEND` statement is used in a selectable stored procedure or `EXECUTE BLOCK` to pass the values of output parameters to a buffer and suspend execution.
...
[[fblangref30-psql-suspend-exmpl]]
==== `SUSPEND` Examples
...
<connection_string> ::=
  !! See <filespec> in the <<fblangref30-ddl-db-create-syntax,`CREATE DATABASE` syntax>> !!

<variables> ::= [:{endsb}__varname__ [, [:{endsb}__varname__ ...]
----

[[fblangref30-psql-tbl-execstmt]]
...
Statements producing multiple rows of data must be executed with <<fblangref30-psql-forexec>>.
====

[[fblangref30-psql-execstmt-wparams]]
...
[[fblangref30-psql-execstmt-wparams01]]
...
[[fblangref30-psql-execstmt-wparms-exmpl]]
...
[[fblangref30-psql-execstmt-wautonomous]]
==== `WITH {AUTONOMOUS | COMMON} TRANSACTION`
...
[[fblangref30-psql-execstmt-wcaller]]
==== `WITH CALLER PRIVILEGES`
...
[[fblangref30-psql-execstmt-onexternal]]
...
[[fblangref30-psql-execstmt-onext-connpool]]
===== Connection Pooling
...
[[fblangref30-psql-execstmt-onext-transpool]]
===== Transaction Pooling
...
[[fblangref30-psql-execstmt-onext-errhandling]]
===== Exception Handling
...
[[fblangref30-psql-execstmt-onext-morenotes]]
===== Miscellaneous Notes
...
[[fblangref30-psql-execstmt-asuser]]
...
[[fblangref30-psql-execstmt-caveats]]
...
.See also
<<fblangref30-psql-forexec>>

[[fblangref30-psql-forselect]]
=== `FOR SELECT`
...
[[fblangref30-psql-tbl-forselect]]
...
[[fblangref30-psql-undeclaredcursor]]
...
// When updating, also update the same list in fblangref30-psql-fetch
...
[[fblangref30-psql-forselect-exmpl]]
...
.See also
<<fblangref30-psql-declare-cursor>>, <<fblangref30-psql-break>>, <<fblangref30-psql-leave>>, <<fblangref30-psql-continue>>, <<fblangref30-psql-exit>>, <<fblangref30-dml-select,`SELECT`>>, <<fblangref30-dml-update,`UPDATE`>>, <<fblangref30-dml-delete,`DELETE`>>
...
.See also
<<fblangref30-psql-execstmt>>, <<fblangref30-psql-break>>, <<fblangref30-psql-leave>>, <<fblangref30-psql-continue>>

[[fblangref30-psql-open]]
=== `OPEN`
...
`OPEN` can be applied only to cursors previously declared in a <<fblangref30-psql-declare-cursor>> statement.
...
.See also
<<fblangref30-psql-declare-cursor>>, <<fblangref30-psql-fetch>>, <<fblangref30-psql-close>>

[[fblangref30-psql-fetch]]
=== `FETCH`
...
The `FETCH` statement can be used only with a cursor declared with the <<fblangref30-psql-declare-cursor>> statement.
...
// When updating also update the same list in fblangref30-psql-undeclaredcursor
.Rules for Cursor Variables
* When accessing a cursor variable in a DML statement, the colon prefix can be added before the cursor name (i.e. `:__cursor_name__.__columnname__`) for disambiguation, similar to variables.
+
The cursor variable can be referenced without colon prefix, but in that case, depending on the scope of the contexts in the statement, the name may resolve in the statement context instead of to the cursor (e.g. you select from a table with the same name as the cursor).
...
This means that an `UPDATE` statement (with a `WHERE CURRENT OF` clause) will update not only the table, but also the fields in the cursor variable for subsequent reads.
Executing a `DELETE` statement (with a `WHERE CURRENT OF` clause) will set all fields in the cursor variable to `NULL` for subsequent reads
// Don't include in fblangref30-psql-undeclaredcursor
...
.See also
<<fblangref30-psql-declare-cursor>>, <<fblangref30-psql-open>>, <<fblangref30-psql-close>>

[[fblangref30-psql-close]]
=== `CLOSE`
...
Only a cursor that was declared with <<fblangref30-psql-declare-cursor>> can be closed with a `CLOSE` statement.

[[fblangref30-psql-close-exmpl]]
==== `CLOSE` Examples

See <<fblangref30-psql-fetch-exmpl>>

.See also
<<fblangref30-psql-declare-cursor>>, <<fblangref30-psql-open>>, <<fblangref30-psql-fetch>>

[[fblangref30-psql-inauton]]
...
.See also
<<fblangref30-transacs,`Transaction Control`>>

[[fblangref30-psql-postevent]]
=== `POST_EVENT`
...
[[fblangref30-psql-tbl-postevent]]
...
[[fblangref30-psql-postevent-exmpl]]
==== `POST_EVENT` Examples
...
[[fblangref30-psql-return-exmpl]]
==== `RETURN` Examples

See <<fblangref30-ddl-func-create-example,`CREATE FUNCTION` Examples>>

[[fblangref30-psql-handleexceptions]]
...
In PSQL code, exceptions are handled by means of the <<fblangref30-psql-when>> statement.
...
Complete listings of the system exceptions can be found in <<fblangref30-appx02-errorcodes,_Appendix B: Exception Codes and Messages_>>:

* <<fblangref30-appx02-sqlstates,SQLSTATE Error Codes and Descriptions>>
* <<fblangref30-appx02-sqlcodes,"GDSCODE Error Codes, SQLCODEs and Descriptions">>

[[fblangref30-ddl-customexcept]]
=== Custom Exceptions
...
For details, see <<fblangref30-ddl-exception-create,`CREATE EXCEPTION`>>.

[[fblangref30-psql-exception]]
=== `EXCEPTION`
...
[[fblangref30-psql-tbl-exception]]
...
Exceptions can be handled in a <<fblangref30-psql-when>> statement.
...
Use of <<fblangref30-ddl-tbl-external,external tables>> can be useful here, as data written to them is transaction-independent.
The linked external file will still be there, regardless of whether the overall process succeeds or not.
====

[[fblangref30-psql-whendo-exmpl]]
...
.See also
<<fblangref30-psql-exception>>, <<fblangref30-ddl-exception-create,`CREATE EXCEPTION`>>, <<fblangref30-appx02-tbl-errcodes01,SQLCODE and GDSCODE Error Codes and Message Texts>> and <<fblangref30-appx02-tbl-sqlstates,SQLSTATE Codes and Message Texts>>, <<fblangref30-contextvars-gdscode,`GDSCODE`>>, <<fblangref30-contextvars-sqlcode,`SQLCODE`>>, <<fblangref30-contextvars-sqlstate,`SQLSTATE`>>
