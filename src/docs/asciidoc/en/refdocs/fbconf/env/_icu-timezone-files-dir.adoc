...
For more information, see https://firebirdsql.org/file/documentation/chunk/en/refdocs/fblangref50/fblangref50-datatypes-datetime.html#fblangref50-datatypes-tz-dbupdate[Updating the Time Zone Database] of the _Firebird 5.0 Language Reference_.
