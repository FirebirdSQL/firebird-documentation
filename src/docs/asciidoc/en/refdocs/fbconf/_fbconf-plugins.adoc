...
These are keyword-value pairs which can occur multiple times, with different values.
...
// TODO Document configuration options of default plugins (it looks like only udr_engine / UDR has config)
