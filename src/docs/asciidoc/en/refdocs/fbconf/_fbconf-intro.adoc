...
https://firebirdsql.org/en/about-firebird/[Firebird] is a SQL relational database management system.
In simple use-cases, you can install it and use its default configuration.
For more advanced use-cases, or when you want to tune Firebird to get the best performance, you will need to dig into its configuration options.
...
////
and -- for a limited subset -- options configured through command line tools like https://firebirdsql.org/file/documentation/html/en/firebirddocs/gfix/firebird-gfix.html[_gfix_] and SQL statements like https://firebirdsql.org/file/documentation/chunk/en/refdocs/fblangref50/fblangref50-ddl.html#fblangref50-ddl-db-create[`CREATE DATABASE`] or https://firebirdsql.org/file/documentation/chunk/en/refdocs/fblangref50/fblangref50-ddl.html#fblangref50-ddl-db-alter[`ALTER DATABASE`].
////
...
This manual may contain documentation of new features and changes of unreleased Firebird versions to simplify manual maintenance.
Such features may be removed or changed before release of that Firebird version.
