...
At time of writing, only the _Firebird 4.0 Release Notes_ document https://firebirdsql.org/file/documentation/release_notes/html/en/4_0/rlsnotes40.html#rnfb40-replication[replication].
...
The configuration items are listed in the order of appearance in the default `replication.conf` file.
