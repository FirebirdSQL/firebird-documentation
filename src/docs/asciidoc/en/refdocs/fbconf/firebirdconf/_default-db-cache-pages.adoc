...
A backup with https://firebirdsql.org/file/documentation/html/en/firebirddocs/gbak/firebird-gbak.html[`gbak`] will record the current configuration in the backup file -- even if it is derived from `DefaultDbCachePages` and not explicitly set.
