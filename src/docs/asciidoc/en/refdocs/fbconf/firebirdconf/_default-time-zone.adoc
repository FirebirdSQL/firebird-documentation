...
The value of _time-zone-name_ is a time zone identifier string, as documented in https://firebirdsql.org/file/documentation/chunk/en/refdocs/fblangref50/fblangref50-datatypes-datetime.html#fblangref50-datatypes-tz-format[Firebird 5.0 Language Reference -- Time Zone Format].
