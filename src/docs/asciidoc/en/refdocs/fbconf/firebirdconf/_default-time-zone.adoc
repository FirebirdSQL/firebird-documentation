...
The value of _time-zone-name_ is a time zone identifier string, as documented in https://firebirdsql.org/file/documentation/chunk/en/refdocs/fblangref50/fblangref50-datatypes-datetime.html#fblangref50-datatypes-tz-format[Time Zone Format] in the _Firebird 5.0 Language Reference_.
