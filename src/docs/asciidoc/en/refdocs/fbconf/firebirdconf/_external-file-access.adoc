...
For more information on external tables, see section https://firebirdsql.org/file/documentation/chunk/en/refdocs/fblangref50/fblangref50-ddl-table.html#fblangref50-ddl-tbl-external[External Tables] in the _Firebird 5.0 Language Reference_.
...
.See also
<<fbconf-database-access>>, <<fbconf-udf-access>>
