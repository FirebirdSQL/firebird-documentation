...
See also https://firebirdsql.org/file/documentation/release_notes/html/en/4_0/rlsnotes40.html#rnfb40-engine-trans-commit-order[Commit Order for Capturing the Database Snapshot] in the _Firebird 4.0 Release Notes_.
