...
The user manager plugins are also used to populate the https://firebirdsql.org/file/documentation/chunk/en/refdocs/fblangref50/fblangref50-appx06-users.html#fblangref50-appx06-users[`SEC$USERS`^] and https://firebirdsql.org/file/documentation/chunk/en/refdocs/fblangref50/fblangref50-appx06-userattr.html#fblangref50-appx06-userattr[`SEC$USER_ATTRIBUTES`^] virtual tables.

The first plugin listed is the _default_ user manager.
The default user manager is used if the `USING PLUGIN` clause is absent from https://firebirdsql.org/file/documentation/chunk/en/refdocs/fblangref50/fblangref50-security-user.html#fblangref50-security-user[user management statements^].
...
Disabling user management this way will also prevent users from changing their own passwords (e.g. using https://firebirdsql.org/file/documentation/chunk/en/refdocs/fblangref50/fblangref50-security-user.html#fblangref50-security-user-alter[`ALTER CURRENT USER`]).
====
