...
Whenever possible, use the `isc_dpb_set_bind` connection property or the https://firebirdsql.org/file/documentation/chunk/en/refdocs/fblangref50/fblangref50-management.html#fblangref50-management-setbind[`SET BIND`] statement instead.
...
|NUMERIC(p[,s]) p{nbsp}>{nbsp}18
|NUMERIC(18[,s])
|2.5, 3.0

|DECIMAL(p[,s]) p{nbsp}>{nbsp}18
|DECIMAL(18[,s])
|2.5, 3.0
