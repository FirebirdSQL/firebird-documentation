...
Enabling `TCP_NODELAY` (disabling "`Nagle's algorithm`", the default) can improve the responsiveness of network connections, as the socket will not try to coalesce small packets.
