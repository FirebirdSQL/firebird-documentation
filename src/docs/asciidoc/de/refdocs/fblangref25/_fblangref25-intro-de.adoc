...
* http://www.moex.com[Moscow Exchange] (Russland) 
+
...
* http://www.ib-aid.com[IBSurgeon] (http://ibase.ru[ibase.ru]) (Russland)
+
...
* http://www.syntess.nl[Syntess Software BV] (Niederlande)
* http://www.mitaro.li[Mitaro Business Solutions] (Liechtenstein)
