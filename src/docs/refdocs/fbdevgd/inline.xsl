...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="classname"> <!-- see note below !! -->
...
<!-- The template above (classname) is used in the Developer's Guide to help with 
     recognition of client-language class names.  No corresponding modification was 
     done in the CSS to apply the same distinction in the HTML builds.  As it is not 
     known whether the classname template is used in other documents, this version 
     of inline.xsl should be used only for the PDF builds of the Developer's Guide.
-->
